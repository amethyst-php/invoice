...
namespace Railken\LaraOre\InvoiceTax\Attributes\Id;
...
class IdAttribute extends BaseAttribute
{
    ...
    protected $permissions = [
        Tokens::PERMISSION_FILL => 'invoicetax.attributes.id.fill',
        Tokens::PERMISSION_SHOW => 'invoicetax.attributes.id.show',
    ];
